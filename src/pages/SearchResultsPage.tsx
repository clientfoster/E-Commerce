...
export function SearchResultsPage() {
  ...
  const fetchProducts = async (pageNum: number) => {
    ...
    try {
      ...
      if (allProducts) {
        const filteredProducts = (allProducts as Product[]).filter(product => 
        ...
        // For simplicity, we'll assume no more results after first page
        setHasMore(false);
      }
    } catch (error) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {products.length === 0 && !loading ? (
          <div className="text-center py-20">
            ...
            <p className="text-gray-600 mb-6">Try different search terms or browse our categories.</p>
          </div>
        ) : (
          <>
            <motion.div 
